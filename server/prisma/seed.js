...
<p>Efek samping imunisasi umumnya ringan seperti demam ringan atau bengkak di area suntikan. Hal ini merupakan reaksi normal dan akan hilang dalam beberapa hari.</p>`,
      ...
      authorId: admin.id,
      seoTitle: 'Pentingnya Imunisasi Dasar Lengkap untuk Bayi | Posyandu Mawar',
...
<li>Puree labu kuning</li>
      ...
      authorId: admin.id,
      seoTitle: 'Panduan MPASI Bayi 6 Bulan | Posyandu Mawar',
...
<p>Bawa anak ke Posyandu setiap bulan untuk ditimbang dan dicatat perkembangannya. Hal ini penting untuk deteksi dini masalah pertumbuhan dan gizi anak.</p>`,
      ...
      authorId: admin.id,
      seoTitle: 'Memantau Tumbuh Kembang Anak dengan KMS | Posyandu Mawar',
  ...
  // ========================
  const settings = [
    { key: 'site_name', value: 'Posyandu Mawar' },
    { key: 'site_description', value: 'Pos Pelayanan Terpadu (Posyandu) Mawar melayani kesehatan ibu, bayi, dan balita di wilayah RW 05.' },
    { key: 'site_logo', value: '' },
    { key: 'address', value: 'Jl. Mawar No. 10, RT 03/RW 05, Kelurahan Sukamaju, Kecamatan Sehat Sejahtera' },
    { key: 'phone', value: '(021) 1234-5678' },
    { key: 'email', value: 'posyandumawar@gmail.com' },
    ...
    { key: 'facebook', value: 'https://facebook.com/posyandumawar' },
    { key: 'instagram', value: 'https://instagram.com/posyandumawar' },
    { key: 'tiktok', value: '' },
    { key: 'youtube', value: '' },
    { key: 'footer_text', value: '© 2026 Posyandu Mawar. Seluruh hak cipta dilindungi.' },
    ...
    { key: 'history', value: 'Posyandu Mawar berdiri sejak tahun 2005 atas inisiatif ibu-ibu PKK dan kader kesehatan di wilayah RW 05. Awalnya kegiatan dilakukan secara sederhana di halaman rumah warga, kemudian berkembang menjadi pos pelayanan tetap yang melayani lebih dari 200 balita dan ibu hamil setiap bulannya. Dengan dukungan Puskesmas setempat dan partisipasi aktif masyarakat, Posyandu Mawar terus meningkatkan kualitas layanan kesehatan untuk mewujudkan generasi sehat dan cerdas.' },
    ...
    { key: 'hero_title', value: 'Portal Informasi Layanan Kesehatan' },
    { key: 'hero_subtitle', value: 'Posyandu Mawar Desa Klari' },
    { key: 'hero_image', value: '' },
    { key: 'social_instagram', value: 'https://instagram.com/posyandumawar.klari' },
    { key: 'social_facebook', value: 'https://facebook.com/posyandumawar' },
    { key: 'social_youtube', value: 'https://youtube.com/c/posyandumawar' },
  ];
